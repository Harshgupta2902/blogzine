            ...
            <form action='' enctype="multipart/form-data" method='POST' onsubmit="">
              ...
              <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea required name="short_description" class="form-control" rows="3" ><?= $blog['description'] ?></textarea>
                </div>
              </div>
                    ...
                    <div class="row align-items-center mb-2">
                      <div class="col-4 col-md-2">
                        <div class="position-relative">
                          <img class="rounded" src="<?= $blog['image'] ?>" alt="">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" name="meta_description"><?= isset($blog['meta_description']) ? $blog['meta_description'] : '' ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" name="meta_keywords"><?= isset($blog['meta_keywords']) ? $blog['meta_keywords'] : '' ?></textarea>
                        </div>
                    </div>
